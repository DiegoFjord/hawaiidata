...
namespace myapp.Controllers
{
  ...
  {
      return Content(MLserv.createprediction(Temp,Dew,Humidity,Precip,Precipprob,Precipcover,Windgust,Windspeed,Cloudcover,Visibility,Solarradiation,Uvindex,Sunrise,Sunset));
      //return Ok();
  }
 }
}
